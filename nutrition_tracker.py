...
# -----------------------------------------------------------------------------
# Cell 5: Nutritional Calculation Functions (MODIFIED)
# -----------------------------------------------------------------------------
...
def calculate_personalized_targets(age, height_cm, weight_kg, sex='male', activity_level='moderately_active', 
    ...
    # ***MODIFICATION START: Calculate hydration needs***
    hydration_needs = calculate_hydration_needs(weight_kg, activity_level)
    # ***MODIFICATION END***
    ...
    targets = {
        ...
        'goal': goal,
        # ***MODIFICATION START: Add hydration to targets dictionary***
        'hydration_ml': hydration_needs
        # ***MODIFICATION END***
    }
...
# -----------------------------------------------------------------------------
# Cell 9: Enhanced Target Display System (MODIFIED)
# -----------------------------------------------------------------------------
...
# ***MODIFICATION START: Unified metrics display with hydration***
metrics_config = [
    {
        'title': 'Metabolic Information', 'columns': 5, # Changed from 4 to 5
        'metrics': [
    ...
    {
        'title': 'Daily Nutritional Target Breakdown', 'columns': 5, # Changed from 4 to 5
        'metrics': [
