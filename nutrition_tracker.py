# ----------------------------------------------------------------------------- 
 ...
 with st.expander("📚 **Scientific Foundation & Evidence-Based Approach**", expanded=False): 
 	 st.markdown(""" 
 	 ### **Energy Foundation: BMR & TDEE** **Basal Metabolic Rate (BMR):** Your body's energy needs at complete rest, calculated using the **Mifflin-St Jeor equation** - the most accurate formula recognized by the Academy of Nutrition and Dietetics. 
 	 ...
 	 **Total Daily Energy Expenditure (TDEE):** Your maintenance calories including daily activities, calculated by multiplying BMR by scientifically validated activity factors. 
 	 ...
 	 ### **Goal-Specific Approach** Rather than using arbitrary caloric adjustments, this tracker uses **percentage-based adjustments** that scale appropriately to your individual metabolism: 
 	 ...
 	 ### **Protein-First Macronutrient Strategy** This evidence-based approach prioritizes protein needs first, then allocates fat for hormonal health (minimum 20% of calories), with carbohydrates filling remaining energy needs: 
 ...
 with st.sidebar.expander("📋 **Activity Level Guide**"): 
 	 st.markdown(""" 
 	 **Choose the level that best describes your weekly activity:** • **Sedentary:** Little to no exercise, desk job 
 ...
 with st.sidebar.expander("🏆 **Food Emoji Guide**"): 
 	 st.markdown(""" 
 	 **Our foods are ranked by nutritional density:** 🥇 **Gold Medal:** Top performer in both calories AND primary nutrient 
 ...
 metrics_config = [ 
 	 { 
 		 ...
 		 'metrics': [ 
 			 ...
 			 ("Daily Hydration Target", f"{targets['hydration_ml']} ml ({targets['hydration_ml']/250:.1f} cups)") 
 		 ] 
 	 }, 
 	 { 
 ...
 with st.expander("🏆 **Essential Tips for Success**", expanded=True): 
 	 st.markdown(""" 
 	 ### **The Foundation Trio for Success** **💧 Hydration Protocol:** - **Target:** 35ml per kg body weight daily 
 	 - **Training bonus:** +500-750ml per hour of exercise 
 	 - **Fat loss hack:** 500ml water before meals increases satiety by 13% 
 	 
 	 **😴 Sleep Quality (The Game-Changer):** - **< 7 hours sleep** reduces fat loss effectiveness by up to 55% 
 	 ...
 	 **⚖️ Weigh-In Best Practices:** - **Daily:** Same time (morning, post-bathroom, minimal clothing) 
 ...
 with st.expander("📊 **Advanced Monitoring & Psychology**"): 
 	 st.markdown(""" 
 	 ### **Beyond the Scale: Better Progress Indicators** - **Progress photos:** Same lighting, poses, time of day 
 	 - **Body measurements:** Waist, hips, arms, thighs (monthly) 
 	 - **Performance metrics:** Strength gains, energy levels, sleep quality 
 	 
 	 ### **The Psychology of Sustainable Change** **80/20 Rule:** Aim for 80% adherence rather than perfection - this allows for social flexibility and prevents the "all-or-nothing" mentality that leads to diet cycling. 
 	 
 	 **Progressive Implementation:** - **Week 1-2:** Focus only on hitting calorie targets 
 ...
 with st.expander("🔄 **Plateau Prevention & Meal Timing**"): 
 	 st.markdown(""" 
 	 ### **Plateau Troubleshooting Flow** **Weight Loss Plateaus:** 1. Confirm logging accuracy (±5% calories) 
 	 ...
 	 **Weight Gain Plateaus:** 1. Increase liquid calories (smoothies, milk) 
 	 ...
 	 ### **Meal Timing & Distribution** **Protein Optimization:** - **Distribution:** 20-30g across 3-4 meals (0.4-0.5g per kg body weight per meal) 
 	 - **Post-workout:** 20-40g within 2 hours of training 
 	 - **Pre-sleep:** 20-30g casein for overnight muscle protein synthesis 
 	 
 	 **Performance Timing:** - **Pre-workout:** Moderate carbs + protein 1-2 hours prior 
 ...
 with st.expander("🌱 **Food Quality & Micronutrient Optimization**"): 
 	 st.markdown(""" 
 	 ### **Satiety Hierarchy (for Better Adherence)** 1. **Protein** (highest satiety per calorie) 
 	 ...
 	 **Volume Eating Strategy:** Prioritize low-calorie, high-volume foods (leafy greens, cucumbers, berries) to create meal satisfaction without exceeding calorie targets. 
 	 ...
 	 ### **Micronutrient Considerations** **Common Shortfalls in Plant-Forward Diets:** - **B₁₂, iron, calcium, zinc, iodine, omega-3 (EPA/DHA)** - **Strategy:** Include fortified foods or consider targeted supplementation based on lab work 
 	 """) 

 # ------ Long-Term Success Framework ------ 
 with st.expander("🎯 **Long-Term Success Framework**"): 
 	 st.markdown(""" 
 	 ### **Maintenance Practice Concept** - Spend time at maintenance calories between diet phases 
 	 ...
 	 ### **Metabolic Adaptation Awareness** - BMR decreases 10-25% during prolonged restriction 
 	 - Recalculate targets every 4-6 weeks as weight changes 
 	 - TDEE naturally adjusts with body weight changes 
 	 
 	 ### **Red Flag Adjustments** - **Too fast weight loss (>1% body weight/week):** Increase calories to prevent muscle loss 
 ...
 with st.expander("📈 **Dynamic Monitoring Tips**"): 
 	 ...
 	 **Why targets change:** - As you lose weight, your BMR and TDEE naturally decrease (smaller body = less energy needed) 
 	 ...
 	 **When to recalculate:** - **Every 4-6 weeks** or after **2-3 kg weight change** - Update your weight in the sidebar and generate new targets 
 	 - Compare your actual vs. predicted weight change weekly 
 	 
 	 **Patience is key:** - Weight can fluctuate 1-3 kg daily (water, glycogen, digestion) 
 ...
 st.markdown("---") 
 st.markdown(""" 
 ### **📚 Evidence-Based References & Methodology** This nutrition tracker is built on peer-reviewed research and evidence-based guidelines: 
 ...
 ### **⚠️ Important Disclaimers** - This tool provides general nutrition guidance based on population averages 
 ...
 ### **🔬 Continuous Improvement** This tracker incorporates the latest nutrition science. As research evolves, recommendations may be updated to reflect current best practices. 
